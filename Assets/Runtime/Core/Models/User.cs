...
namespace Appwrite.Models
{
    public class User
    {
        ...
        public static User From(Dictionary<string, object> map) => new User(
            ...
            password: map.ContainsKey("password") ? map["password"]?.ToString() : null,
            hash: map.ContainsKey("hash") ? map["hash"]?.ToString() : null,
            hashOptions: map.ContainsKey("hashOptions") ? map["hashOptions"]?.ToString() : null,
