...
namespace Appwrite.Services
{
    public class Vcs : Service
    {
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.DetectionFramework> CreateRepositoryDetection(string installationId, string providerRepositoryId, Appwrite.Enums.VCSDetectionType type, string? providerRootDirectory = null)
        {
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.ProviderRepositoryFrameworkList> ListRepositories(string installationId, Appwrite.Enums.VCSDetectionType type, string? search = null)
        {
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.ProviderRepository> CreateRepository(string installationId, string name, bool xprivate)
        {
            var apiPath = "/vcs/github/installations/{installationId}/providerRepositories"
                .Replace("{installationId}", installationId);
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.ProviderRepository> GetRepository(string installationId, string providerRepositoryId)
        {
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.BranchList> ListRepositoryBranches(string installationId, string providerRepositoryId)
        {
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.VcsContentList> GetRepositoryContents(string installationId, string providerRepositoryId, string? providerRootDirectory = null, string? providerReference = null)
        {
        ...
        /// </para>
        /// </summary>
        public UniTask<object> UpdateExternalDeployments(string installationId, string repositoryId, string providerPullRequestId)
        {
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.InstallationList> ListInstallations(List<string>? queries = null, string? search = null)
        {
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.Installation> GetInstallation(string installationId)
        {
