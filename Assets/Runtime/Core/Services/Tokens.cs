...
namespace Appwrite.Services
{
    public class Tokens : Service
    {
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.ResourceTokenList> List(string bucketId, string fileId, List<string>? queries = null)
        {
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.ResourceToken> CreateFileToken(string bucketId, string fileId, string? expire = null)
        {
            var apiPath = "/tokens/buckets/{bucketId}/files/{fileId}"
                .Replace("{bucketId}", bucketId)
                .Replace("{fileId}", fileId);
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.ResourceToken> Get(string tokenId)
        {
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.ResourceToken> Update(string tokenId, string? expire = null)
        {
            var apiPath = "/tokens/{tokenId}"
                .Replace("{tokenId}", tokenId);
        ...
        /// </para>
        /// </summary>
        public UniTask<object> Delete(string tokenId)
        {
            var apiPath = "/tokens/{tokenId}"
                .Replace("{tokenId}", tokenId);
