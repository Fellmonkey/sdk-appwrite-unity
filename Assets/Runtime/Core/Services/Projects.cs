...
namespace Appwrite.Services
{
    public class Projects : Service
    {
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.ProjectList> List(List<string>? queries = null, string? search = null)
        {
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.Project> Get(string projectId)
        {
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.Project> Update(string projectId, string name, string? description = null, string? logo = null, string? url = null, string? legalName = null, string? legalCountry = null, string? legalState = null, string? legalCity = null, string? legalAddress = null, string? legalTaxId = null)
        {
            var apiPath = "/projects/{projectId}"
                .Replace("{projectId}", projectId);
        ...
        /// </para>
        /// </summary>
        public UniTask<object> Delete(string projectId)
        {
            var apiPath = "/projects/{projectId}"
                .Replace("{projectId}", projectId);
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.Project> UpdateApiStatus(string projectId, Appwrite.Enums.Api api, bool status)
        {
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.Project> UpdateApiStatusAll(string projectId, bool status)
        {
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.Project> UpdateAuthDuration(string projectId, long duration)
        {
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.Project> UpdateAuthLimit(string projectId, long limit)
        {
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.Project> UpdateAuthSessionsLimit(string projectId, long limit)
        {
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.Project> UpdateMembershipsPrivacy(string projectId, bool userName, bool userEmail, bool mfa)
        {
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.Project> UpdateMockNumbers(string projectId, List<object> numbers)
        {
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.Project> UpdateAuthPasswordDictionary(string projectId, bool enabled)
        {
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.Project> UpdateAuthPasswordHistory(string projectId, long limit)
        {
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.Project> UpdatePersonalDataCheck(string projectId, bool enabled)
        {
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.Project> UpdateSessionAlerts(string projectId, bool alerts)
        {
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.Project> UpdateAuthStatus(string projectId, Appwrite.Enums.AuthMethod method, bool status)
        {
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.DevKeyList> ListDevKeys(string projectId, List<string>? queries = null)
        {
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.DevKey> CreateDevKey(string projectId, string name, string expire)
        {
            var apiPath = "/projects/{projectId}/dev-keys"
                .Replace("{projectId}", projectId);
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.DevKey> GetDevKey(string projectId, string keyId)
        {
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.DevKey> UpdateDevKey(string projectId, string keyId, string name, string expire)
        {
            var apiPath = "/projects/{projectId}/dev-keys/{keyId}"
                .Replace("{projectId}", projectId)
                .Replace("{keyId}", keyId);
        ...
        /// </para>
        /// </summary>
        public UniTask<object> DeleteDevKey(string projectId, string keyId)
        {
            var apiPath = "/projects/{projectId}/dev-keys/{keyId}"
                .Replace("{projectId}", projectId)
                .Replace("{keyId}", keyId);
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.JWT> CreateJWT(string projectId, List<string> scopes, long? duration = null)
        {
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.KeyList> ListKeys(string projectId)
        {
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.Key> CreateKey(string projectId, string name, List<string> scopes, string? expire = null)
        {
            var apiPath = "/projects/{projectId}/keys"
                .Replace("{projectId}", projectId);
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.Key> GetKey(string projectId, string keyId)
        {
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.Key> UpdateKey(string projectId, string keyId, string name, List<string> scopes, string? expire = null)
        {
            var apiPath = "/projects/{projectId}/keys/{keyId}"
                .Replace("{projectId}", projectId)
                .Replace("{keyId}", keyId);
        ...
        /// </para>
        /// </summary>
        public UniTask<object> DeleteKey(string projectId, string keyId)
        {
            var apiPath = "/projects/{projectId}/keys/{keyId}"
                .Replace("{projectId}", projectId)
                .Replace("{keyId}", keyId);
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.Project> UpdateOAuth2(string projectId, Appwrite.Enums.OAuthProvider provider, string? appId = null, string? secret = null, bool? enabled = null)
        {
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.PlatformList> ListPlatforms(string projectId)
        {
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.Platform> CreatePlatform(string projectId, Appwrite.Enums.PlatformType type, string name, string? key = null, string? store = null, string? hostname = null)
        {
            var apiPath = "/projects/{projectId}/platforms"
                .Replace("{projectId}", projectId);
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.Platform> GetPlatform(string projectId, string platformId)
        {
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.Platform> UpdatePlatform(string projectId, string platformId, string name, string? key = null, string? store = null, string? hostname = null)
        {
            var apiPath = "/projects/{projectId}/platforms/{platformId}"
                .Replace("{projectId}", projectId)
                .Replace("{platformId}", platformId);
        ...
        /// </para>
        /// </summary>
        public UniTask<object> DeletePlatform(string projectId, string platformId)
        {
            var apiPath = "/projects/{projectId}/platforms/{platformId}"
                .Replace("{projectId}", projectId)
                .Replace("{platformId}", platformId);
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.Project> UpdateServiceStatus(string projectId, Appwrite.Enums.ApiService service, bool status)
        {
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.Project> UpdateServiceStatusAll(string projectId, bool status)
        {
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.Project> UpdateSmtp(string projectId, bool enabled, string? senderName = null, string? senderEmail = null, string? replyTo = null, string? host = null, long? port = null, string? username = null, string? password = null, Appwrite.Enums.SMTPSecure? secure = null)
        {
        ...
        /// </para>
        /// </summary>
        public UniTask<object> CreateSmtpTest(string projectId, List<string> emails, string senderName, string senderEmail, string host, string? replyTo = null, long? port = null, string? username = null, string? password = null, Appwrite.Enums.SMTPSecure? secure = null)
        {
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.Project> UpdateTeam(string projectId, string teamId)
        {
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.EmailTemplate> GetEmailTemplate(string projectId, Appwrite.Enums.EmailTemplateType type, Appwrite.Enums.EmailTemplateLocale locale)
        {
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.EmailTemplate> UpdateEmailTemplate(string projectId, Appwrite.Enums.EmailTemplateType type, Appwrite.Enums.EmailTemplateLocale locale, string subject, string message, string? senderName = null, string? senderEmail = null, string? replyTo = null)
        {
            var apiPath = "/projects/{projectId}/templates/email/{type}/{locale}"
                .Replace("{projectId}", projectId)
                .Replace("{type}", type.Value)
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.EmailTemplate> DeleteEmailTemplate(string projectId, Appwrite.Enums.EmailTemplateType type, Appwrite.Enums.EmailTemplateLocale locale)
        {
            var apiPath = "/projects/{projectId}/templates/email/{type}/{locale}"
                .Replace("{projectId}", projectId)
                .Replace("{type}", type.Value)
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.SmsTemplate> GetSmsTemplate(string projectId, Appwrite.Enums.SmsTemplateType type, Appwrite.Enums.SmsTemplateLocale locale)
        {
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.SmsTemplate> UpdateSmsTemplate(string projectId, Appwrite.Enums.SmsTemplateType type, Appwrite.Enums.SmsTemplateLocale locale, string message)
        {
            var apiPath = "/projects/{projectId}/templates/sms/{type}/{locale}"
                .Replace("{projectId}", projectId)
                .Replace("{type}", type.Value)
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.SmsTemplate> DeleteSmsTemplate(string projectId, Appwrite.Enums.SmsTemplateType type, Appwrite.Enums.SmsTemplateLocale locale)
        {
            var apiPath = "/projects/{projectId}/templates/sms/{type}/{locale}"
                .Replace("{projectId}", projectId)
                .Replace("{type}", type.Value)
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.WebhookList> ListWebhooks(string projectId)
        {
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.Webhook> CreateWebhook(string projectId, string name, List<string> events, string url, bool security, bool? enabled = null, string? httpUser = null, string? httpPass = null)
        {
            var apiPath = "/projects/{projectId}/webhooks"
                .Replace("{projectId}", projectId);
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.Webhook> GetWebhook(string projectId, string webhookId)
        {
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.Webhook> UpdateWebhook(string projectId, string webhookId, string name, List<string> events, string url, bool security, bool? enabled = null, string? httpUser = null, string? httpPass = null)
        {
            var apiPath = "/projects/{projectId}/webhooks/{webhookId}"
                .Replace("{projectId}", projectId)
                .Replace("{webhookId}", webhookId);
        ...
        /// </para>
        /// </summary>
        public UniTask<object> DeleteWebhook(string projectId, string webhookId)
        {
            var apiPath = "/projects/{projectId}/webhooks/{webhookId}"
                .Replace("{projectId}", projectId)
                .Replace("{webhookId}", webhookId);
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.Webhook> UpdateWebhookSignature(string projectId, string webhookId)
        {
