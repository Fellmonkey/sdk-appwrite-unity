...
namespace Appwrite.Services
{
    public class Users : Service
    {
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.UserList> List(List<string>? queries = null, string? search = null)
        {
            var apiPath = "/users";
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.User> Create(string userId, string? email = null, string? phone = null, string? password = null, string? name = null)
        {
            var apiPath = "/users";
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.User> CreateArgon2User(string userId, string email, string password, string? name = null)
        {
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.User> CreateBcryptUser(string userId, string email, string password, string? name = null)
        {
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.IdentityList> ListIdentities(List<string>? queries = null, string? search = null)
        {
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.User> CreateMD5User(string userId, string email, string password, string? name = null)
        {
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.User> CreatePHPassUser(string userId, string email, string password, string? name = null)
        {
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.User> CreateScryptUser(string userId, string email, string password, string passwordSalt, long passwordCpu, long passwordMemory, long passwordParallel, long passwordLength, string? name = null)
        {
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.User> CreateScryptModifiedUser(string userId, string email, string password, string passwordSalt, string passwordSaltSeparator, string passwordSignerKey, string? name = null)
        {
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.User> CreateSHAUser(string userId, string email, string password, Appwrite.Enums.PasswordHash? passwordVersion = null, string? name = null)
        {
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.UsageUsers> GetUsage(Appwrite.Enums.UserUsageRange? range = null)
        {
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.User> Get(string userId)
        {
        ...
        /// </para>
        /// </summary>
        public UniTask<object> Delete(string userId)
        {
            var apiPath = "/users/{userId}"
                .Replace("{userId}", userId);
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.User> UpdateEmail(string userId, string email)
        {
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.JWT> CreateJWT(string userId, string? sessionId = null, long? duration = null)
        {
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.User> UpdateLabels(string userId, List<string> labels)
        {
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.LogList> ListLogs(string userId, List<string>? queries = null)
        {
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.MembershipList> ListMemberships(string userId, List<string>? queries = null, string? search = null)
        {
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.User> UpdateMfa(string userId, bool mfa)
        {
        ...
        /// </para>
        /// </summary>
        public UniTask<object> DeleteMfaAuthenticator(string userId, Appwrite.Enums.AuthenticatorType type)
        {
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.MfaFactors> ListMfaFactors(string userId)
        {
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.MfaRecoveryCodes> GetMfaRecoveryCodes(string userId)
        {
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.MfaRecoveryCodes> UpdateMfaRecoveryCodes(string userId)
        {
            var apiPath = "/users/{userId}/mfa/recovery-codes"
                .Replace("{userId}", userId);
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.MfaRecoveryCodes> CreateMfaRecoveryCodes(string userId)
        {
            var apiPath = "/users/{userId}/mfa/recovery-codes"
                .Replace("{userId}", userId);
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.User> UpdateName(string userId, string name)
        {
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.User> UpdatePassword(string userId, string password)
        {
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.User> UpdatePhone(string userId, string number)
        {
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.Preferences> GetPrefs(string userId)
        {
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.Preferences> UpdatePrefs(string userId, object prefs)
        {
            var apiPath = "/users/{userId}/prefs"
                .Replace("{userId}", userId);
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.SessionList> ListSessions(string userId)
        {
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.Session> CreateSession(string userId)
        {
            var apiPath = "/users/{userId}/sessions"
                .Replace("{userId}", userId);
        ...
        /// </para>
        /// </summary>
        public UniTask<object> DeleteSessions(string userId)
        {
            var apiPath = "/users/{userId}/sessions"
                .Replace("{userId}", userId);
        ...
        /// </para>
        /// </summary>
        public UniTask<object> DeleteSession(string userId, string sessionId)
        {
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.User> UpdateStatus(string userId, bool status)
        {
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.TargetList> ListTargets(string userId, List<string>? queries = null)
        {
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.Target> CreateTarget(string userId, string targetId, Appwrite.Enums.MessagingProviderType providerType, string identifier, string? providerId = null, string? name = null)
        {
            var apiPath = "/users/{userId}/targets"
                .Replace("{userId}", userId);
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.Target> GetTarget(string userId, string targetId)
        {
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.Target> UpdateTarget(string userId, string targetId, string? identifier = null, string? providerId = null, string? name = null)
        {
            var apiPath = "/users/{userId}/targets/{targetId}"
                .Replace("{userId}", userId)
                .Replace("{targetId}", targetId);
        ...
        /// </para>
        /// </summary>
        public UniTask<object> DeleteTarget(string userId, string targetId)
        {
            var apiPath = "/users/{userId}/targets/{targetId}"
                .Replace("{userId}", userId)
                .Replace("{targetId}", targetId);
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.Token> CreateToken(string userId, long? length = null, long? expire = null)
        {
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.User> UpdateEmailVerification(string userId, bool emailVerification)
        {
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.User> UpdatePhoneVerification(string userId, bool phoneVerification)
        {
