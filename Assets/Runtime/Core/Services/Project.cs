...
namespace Appwrite.Services
{
    public class Project : Service
    {
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.UsageProject> GetUsage(string startDate, string endDate, Appwrite.Enums.ProjectUsageRange? period = null)
        {
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.VariableList> ListVariables()
        {
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.Variable> CreateVariable(string key, string xvalue, bool? secret = null)
        {
            var apiPath = "/project/variables";
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.Variable> GetVariable(string variableId)
        {
        ...
        /// </para>
        /// </summary>
        public UniTask<Models.Variable> UpdateVariable(string variableId, string key, string? xvalue = null, bool? secret = null)
        {
            var apiPath = "/project/variables/{variableId}"
                .Replace("{variableId}", variableId);
        ...
        /// </para>
        /// </summary>
        public UniTask<object> DeleteVariable(string variableId)
        {
            var apiPath = "/project/variables/{variableId}"
                .Replace("{variableId}", variableId);
