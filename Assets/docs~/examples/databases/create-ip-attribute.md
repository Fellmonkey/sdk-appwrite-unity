...
public class CreateIpAttributeExample : MonoBehaviour
{
    ...
    async void Start()
    {
        ...
        await ExampleCreateIpAttribute();
    }
    
    async UniTask ExampleCreateIpAttribute()
    {
        try
        {
            // Setup parameters
            ...
            var result = await client.Databases.CreateIpAttributeAsync(
                databaseId,
                collectionId,
                key,
                required
