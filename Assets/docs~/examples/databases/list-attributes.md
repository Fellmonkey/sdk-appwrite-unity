...
public class ListAttributesExample : MonoBehaviour
{
    ...
    async void Start()
    {
        ...
        await ExampleListAttributes();
    }
    
    async UniTask ExampleListAttributes()
    {
        try
        {
            // Setup parameters
            ...
            var result = await client.Databases.ListAttributesAsync(
                databaseId,
                collectionId
            );
