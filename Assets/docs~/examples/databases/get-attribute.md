...
public class GetAttributeExample : MonoBehaviour
{
    ...
    async void Start()
    {
        ...
        await ExampleGetAttribute();
    }
    
    async UniTask ExampleGetAttribute()
    {
        try
        {
            // Setup parameters
            ...
            var result = await client.Databases.GetAttributeAsync(
                databaseId,
                collectionId,
                key
            );
