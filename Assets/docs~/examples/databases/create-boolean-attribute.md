...
public class CreateBooleanAttributeExample : MonoBehaviour
{
    ...
    async void Start()
    {
        ...
        await ExampleCreateBooleanAttribute();
    }
    
    async UniTask ExampleCreateBooleanAttribute()
    {
        try
        {
            // Setup parameters
            ...
            var result = await client.Databases.CreateBooleanAttributeAsync(
                databaseId,
                collectionId,
                key,
                required
