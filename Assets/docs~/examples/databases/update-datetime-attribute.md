...
public class UpdateDatetimeAttributeExample : MonoBehaviour
{
    ...
    async void Start()
    {
        ...
        await ExampleUpdateDatetimeAttribute();
    }
    
    async UniTask ExampleUpdateDatetimeAttribute()
    {
        try
        {
            // Setup parameters
            ...
            var result = await client.Databases.UpdateDatetimeAttributeAsync(
                databaseId,
                collectionId,
                key,
                required,
