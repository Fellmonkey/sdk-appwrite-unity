...
public class CreateEmailAttributeExample : MonoBehaviour
{
    ...
    async void Start()
    {
        ...
        await ExampleCreateEmailAttribute();
    }
    
    async UniTask ExampleCreateEmailAttribute()
    {
        try
        {
            // Setup parameters
            ...
            var result = await client.Databases.CreateEmailAttributeAsync(
                databaseId,
                collectionId,
                key,
                required
